...
Cloud Volumes ONTAP è un'appliance di storage solo software che esegue il software di gestione dei dati ONTAP nel cloud. Offre uno storage Enterprise con le seguenti funzionalità principali:
