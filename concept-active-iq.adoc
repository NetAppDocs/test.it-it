...
Modifica per la localizzazione. Attivare docbot e testare la visualizzazione del blocco. Test della disattivazione dei docbot. Test di aggiornamento Ruby per la terza volta. Test push di Ruby aggiornamento.
